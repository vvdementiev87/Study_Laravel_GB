    ...
    <div>
        ...
        <form method="post" action="{{route('admin.news.update',['news'=>$news])}}">
            ...
            <div class="form-group">
                ...
                <input type="text" id="link" name="link" value="{{$news->link}}" class="form-control @error('link') is-invalid @enderror">
            </div>
            @error('link') <span class="text-danger">{{$message}}</span> @enderror
            <div class="form-group">
                <label for="guid">guid</label>
                <input type="text" id="guid" name="guid" value="{{$news->guid}}" class="form-control @error('guid') is-invalid @enderror">
            </div>
            @error('guid') <span class="text-danger">{{$message}}</span> @enderror
            <div class="form-group">
                <label for="pubDate">дата публикации</label>
                <input type="text" id="pubDate" name="pubDate" value="{{$news->pubDate}}" class="form-control @error('pubDate') is-invalid @enderror">
            </div>
